...
delete= Button(root,text='Remove Students Entry',command=lambda:del_data(root,db))
update= Button(root,text='Update Student Information',command=lambda:update_data(root,db))
show= Button(root,text='Display student Information',command=lambda:display(root,db))
